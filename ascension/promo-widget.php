 ...
 * @extends    WP_Widget
 */
class Promo_Feature_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			...
			'classname'                   => 'widget_text primer-widgets primer-promo-feature-widget',
			'description'                 => sprintf(
				/* translators: theme name */
				esc_html__( "A %s widget designed for the promotional area on your site's front page.", 'primer' ),
				esc_html( $this->get_current_theme_name() )
			),
		);

		parent::__construct( 'promo-feature', /* translators: the widget title */ esc_html__( 'Promo Feature', 'primer' ), $widget_options );
	...
	public function widget( $args, $instance ) {
		...
		?>
		<div class="textwidget primer-widgets promo-feature-widget">
	...
	public function form( $instance ) {
		...
		<div class="primer-widgets promo-feature-widget">
	...
	public function register_scripts() {
		...
		wp_register_script(
			'promo-feature-admin-widget',
			get_stylesheet_directory_uri() . "/promo-feature-widget.js",
		...
		wp_localize_script(
		   ...
		   wp_enqueue_media();
		   wp_enqueue_script('promo_admin', get_stylesheet_directory_uri() . '/promo_admin.js', array('jquery'));
	...
	public function print_scripts() {
		...
		wp_print_scripts( 'promo-feature-admin-widget' );
